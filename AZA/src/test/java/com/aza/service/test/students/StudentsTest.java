...
//	@Test
		public void testAddStudentsNote() throws Exception {
			...
			students.setNoteContent("�̺е� ��ư� ���е� ��ƴ�");
...
//		@Test
		public void testUpdateStudentsNote() throws Exception {
			...
			students.setNoteTitle("�̺а�����");
			students.setNoteContent("�޷�");
