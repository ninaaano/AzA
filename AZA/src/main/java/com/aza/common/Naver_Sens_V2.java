...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        String accessKey = "wGUsYSJx515guIwS0nzm";                     						// 개인 인증키
        String secretKey = "ifmzNoHo4qWlBw2zG3X44wGelseBbbOf5tiu6O5i";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
        String serviceId = "ncp:sms:kr:286287948369:aza";        									// 프로젝트에 할당된 SMS 서비스 ID
	    ...
	    bodyJson.put("from","01032030796");	// 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.		
