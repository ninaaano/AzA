...
public class NaverServiceImpl {
	...
	public static void sendSMS(String phone,String message) {
		...
		String accessKey = "3VSHNldWqnc8zuXTPOG8";                     	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키			// Access Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID
		String secretKey = "ifmzNoHo4qWlBw2zG3X44wGelseBbbOf5tiu6O5i";  // 2차 인증을 위해 서비스마다 할당되는 service secret key	// Service Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID	
		String serviceId = "ncp:sms:kr:286287948369:aza";       // 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
		String method = "POST";											// 요청 method
		String timestamp = Long.toString(System.currentTimeMillis()); 	// current timestamp (epoch)
		requestUrl += serviceId + requestUrlType;
		//String apiUrl = hostNameUrl + requestUrl;
		String apiUrl = "https://sens.apigw.ntruss.com/sms/v2/services/ncp:sms:kr:286287948369:aza/messages";
	    ...
	    //toJson.put("to",phone);	
	    toJson.put("to","01032030796");						// Mandatory(필수), messages.to	수신번호, -를 제외한 숫자만 입력 가능
	    toArr.add(toJson);
