                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                ...
                                <div class="text-center my-5 mt-sm-10">
                                    <img class="img-fluid mb-4" src="/resources/img/error-403.svg" alt="403 Error Image by Freepik Storyset" style="max-width: 30rem" />
                                    <p class="lead">요청하신 소스에 접근할 수 없어요</p>
