									...
									<form>
										<div class="row">
											<div class="col-sm-6 mb-4">
												<mwc-textfield class="w-100" label="아이디" outlined=""></mwc-textfield>
											</div>
											<div class="col-sm-6 mb-4">
												<mwc-textfield class="w-100" label="이름" outlined=""></mwc-textfield>
											</div>
										</div>
										<div class="mb-4">
											<mwc-textfield class="w-100" label="Email Address"
												outlined=""></mwc-textfield>
										</div>
										<div class="row">
											<div class="col-sm-6 mb-4">
												<mwc-textfield class="w-100" label="비밀번호" outlined=""
													icontrailing="visibility_off" type="비밀번호"></mwc-textfield>
											</div>
											<div class="col-sm-6 mb-4">
												<mwc-textfield class="w-100" label="비밀번호 확인"
										...
										<div class="d-flex align-items-center">
											...
											<mwc-checkbox name=""></mwc-checkbox></mwc-formfield>
										</div>
										<div
											class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
											<a class="small fw-500 text-decoration-none"
												href="app-auth-login-basic.html">Sign in instead</a> <a
												class="btn btn-primary mdc-ripple-upgraded"
												href="app-auth-login-basic.html">Create Account</a>
										</div>
									</form>
								</div>
							</div>
							...
							<div class="container row">
								<div class="card card-raised shadow-10 mt-5 mt-xl-10 mb-5">
									<form class="form-horizontal">
										<label for="role"
											class="col-sm-offset-1 col-sm-4 control-label pb-1">회원
											유형을 선택하세요</label>
										<div class="col-sm-4">
										...
										<div class="form-group">
											<label for="userId"
												class="col-sm-offset-1 col-sm-3 control-label">아 이
												디</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" id="userId"
													name="userId" placeholder="아이디를 입력하세요"
													oninput="checkDuplication()" /> <span class="id_ok">사용
													가능한 아이디입니다.</span> <span class="id_already">사용중인 아이디 입니다.</span>
											</div>
										</div>
											...
											<div class="form-row">
												<div class="form-group col-md-4">
													<input type="text" class="form-control" id="certification"
														name="auth" placeholder="인증번호를 입력해주세요" required>
...
-->
			...
			<!-- 
										<div class="parent" style="display: none;">
											<label for="firstStudentId"
												...
												아이디</label>
											<div class="form-group col-md-8">
												<input type="text" class="form-control" id="firstStudentId"
													name="firstStudentId" placeholder="자녀 아이디"
													oninput="checkStudent()" />
										...
										<div class="agree-checkbox">
											<div class="agree__box">
												<input type="checkbox" id="check_service" name="agreecheck"
													onclick="checkSelectAll()" /> <label for="check_service">
													사용자 약관 전체 동의 (필수) </label>
											</div>
										</div>
 ...
 -->
      ...
      function fncAddUser() {
         ...
         var agree=$("input[name='agreecheck']").val();
